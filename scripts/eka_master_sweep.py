...
def run_cmd(cmd, input_str=None, cwd=None):
    ...
    result = subprocess.run(
        cmd, input=input_str, shell=True, text=True, capture_output=True, cwd=cwd
    )
...
run_cmd(
    "pip install -q transformers bitsandbytes accelerate peft datasets numpy scipy kneed scikit-image tqdm evaluate rouge_score"
)
