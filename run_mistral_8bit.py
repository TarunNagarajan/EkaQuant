...
def setup_pristine_environment():
    ...
    old_arc_logic = """                predicted_letter = _parse_predicted_answer(generated_text, lang_code, all_mappings)
                
                # Convert to indices for metric computation"""
    
    new_arc_logic = """                predicted_letter = _parse_predicted_answer(generated_text, lang_code, all_mappings)
